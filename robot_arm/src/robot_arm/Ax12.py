...
class Ax12:
    ...
    def connect(cls):
        ...
        cls.groupSyncRead = GroupSyncRead(cls.portHandler, cls.packetHandler, ADDR_AX_PRESENT_POSITION_L, 2)
        cls.groupSyncWrite = GroupSyncWrite(cls.portHandler, cls.packetHandler, ADDR_AX_GOAL_POSITION_L, 2)
